# Export report-bordered.docx to report-bordered.pdf with Microsoft Word, and report the page count.
#
...
# If you edit it and it hangs, kill WINWORD, delete the ~$report-bordered.docx owner
...
$docx = 'E:\rag-knowledge-system\report\report-bordered.docx'
$pdf = 'E:\rag-knowledge-system\report\report-bordered.pdf'
$lock = 'E:\rag-knowledge-system\report\~$report-bordered.docx'
