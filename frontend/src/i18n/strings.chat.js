...
const en = {
  ...
  "chat.onThisMachine": "On this machine",
  "chat.cloudSection": "Cloud",
  "chat.noteLlama": "Reliable all-rounder",
  "chat.noteQwen": "Strongest reasoning for its size",
  "chat.notePhi": "Best at following detailed steps",
  "chat.noteGranite": "Sticks closest to your documents",
  "chat.noteGemma": "Handles long documents well",
  "chat.noteMistral": "Quick, plain answers",
  "chat.noteCode": "Built for code, not prose",
  "chat.noteThinks": "Thinks step by step before answering",
  "chat.noteQuick": "Fastest for quick answers",
  "chat.noteEveryday": "Balanced for everyday questions",
...
const fr = {
  ...
  "chat.onThisMachine": "Sur cet ordinateur",
  "chat.cloudSection": "Cloud",
  "chat.noteLlama": "Polyvalent et fiable",
  "chat.noteQwen": "Meilleur raisonnement pour sa taille",
  "chat.notePhi": "Le plus fidèle aux consignes détaillées",
  "chat.noteGranite": "S’en tient au plus près de vos documents",
  "chat.noteGemma": "À l’aise avec les longs documents",
  "chat.noteMistral": "Réponses rapides et directes",
  "chat.noteCode": "Conçu pour le code, pas la prose",
  "chat.noteThinks": "Réfléchit étape par étape avant de répondre",
  "chat.noteQuick": "Le plus rapide pour une réponse courte",
  "chat.noteEveryday": "Équilibré pour les questions courantes",
...
const de = {
  ...
  "chat.onThisMachine": "Auf diesem Rechner",
  "chat.cloudSection": "Cloud",
  "chat.noteLlama": "Zuverlässiger Allrounder",
  "chat.noteQwen": "Stärkstes Denkvermögen seiner Größe",
  "chat.notePhi": "Folgt detaillierten Anweisungen am besten",
  "chat.noteGranite": "Bleibt am dichtesten an Ihren Dokumenten",
  "chat.noteGemma": "Kommt gut mit langen Dokumenten zurecht",
  "chat.noteMistral": "Schnelle, schnörkellose Antworten",
  "chat.noteCode": "Für Code gebaut, nicht für Prosa",
  "chat.noteThinks": "Denkt Schritt für Schritt, bevor es antwortet",
  "chat.noteQuick": "Am schnellsten für kurze Antworten",
  "chat.noteEveryday": "Ausgewogen für alltägliche Fragen",
...
const hi = {
  ...
  "chat.onThisMachine": "इस कंप्यूटर पर",
  "chat.cloudSection": "क्लाउड",
  "chat.noteLlama": "हर काम के लिए भरोसेमंद",
  "chat.noteQwen": "अपने आकार में सबसे अच्छा तर्क",
  "chat.notePhi": "विस्तृत निर्देशों का सबसे अच्छा पालन",
  "chat.noteGranite": "आपके दस्तावेज़ों के सबसे नज़दीक रहता है",
  "chat.noteGemma": "लंबे दस्तावेज़ अच्छे से संभालता है",
  "chat.noteMistral": "तेज़, सीधे जवाब",
  "chat.noteCode": "कोड के लिए बना है, गद्य के लिए नहीं",
  "chat.noteThinks": "जवाब देने से पहले कदम दर कदम सोचता है",
  "chat.noteQuick": "छोटे जवाबों के लिए सबसे तेज़",
  "chat.noteEveryday": "रोज़मर्रा के सवालों के लिए संतुलित",
...
const id = {
  ...
  "chat.onThisMachine": "Di komputer ini",
  "chat.cloudSection": "Awan",
  "chat.noteLlama": "Serbaguna dan andal",
  "chat.noteQwen": "Penalaran terbaik di ukurannya",
  "chat.notePhi": "Paling patuh pada instruksi rinci",
  "chat.noteGranite": "Paling setia pada dokumen Anda",
  "chat.noteGemma": "Menangani dokumen panjang dengan baik",
  "chat.noteMistral": "Jawaban cepat dan lugas",
  "chat.noteCode": "Dibuat untuk kode, bukan prosa",
  "chat.noteThinks": "Berpikir bertahap sebelum menjawab",
  "chat.noteQuick": "Tercepat untuk jawaban singkat",
  "chat.noteEveryday": "Seimbang untuk pertanyaan sehari-hari",
...
const it = {
  ...
  "chat.onThisMachine": "Su questo computer",
  "chat.cloudSection": "Cloud",
  "chat.noteLlama": "Affidabile e versatile",
  "chat.noteQwen": "Miglior ragionamento per la sua taglia",
  "chat.notePhi": "Il più fedele alle istruzioni dettagliate",
  "chat.noteGranite": "Resta più aderente ai tuoi documenti",
  "chat.noteGemma": "Gestisce bene i documenti lunghi",
  "chat.noteMistral": "Risposte rapide e dirette",
  "chat.noteCode": "Fatto per il codice, non per la prosa",
  "chat.noteThinks": "Ragiona passo dopo passo prima di rispondere",
  "chat.noteQuick": "Il più veloce per risposte brevi",
  "chat.noteEveryday": "Equilibrato per le domande di ogni giorno",
...
const ja = {
  ...
  "chat.onThisMachine": "このパソコン上",
  "chat.cloudSection": "クラウド",
  "chat.noteLlama": "頼れる万能型",
  "chat.noteQwen": "このサイズで最も高い推論力",
  "chat.notePhi": "細かい指示に最も忠実",
  "chat.noteGranite": "資料に最も忠実に答えます",
  "chat.noteGemma": "長い文書の扱いが得意",
  "chat.noteMistral": "速くて簡潔な回答",
  "chat.noteCode": "文章よりコード向け",
  "chat.noteThinks": "答える前に順を追って考えます",
  "chat.noteQuick": "短い回答に最速",
  "chat.noteEveryday": "日常の質問にちょうどよい",
...
const ko = {
  ...
  "chat.onThisMachine": "이 컴퓨터에서",
  "chat.cloudSection": "클라우드",
  "chat.noteLlama": "믿음직한 만능형",
  "chat.noteQwen": "같은 크기에서 가장 뛰어난 추론",
  "chat.notePhi": "자세한 지시를 가장 잘 따름",
  "chat.noteGranite": "문서에 가장 충실하게 답변",
  "chat.noteGemma": "긴 문서를 잘 다룸",
  "chat.noteMistral": "빠르고 간결한 답변",
  "chat.noteCode": "산문보다 코드에 적합",
  "chat.noteThinks": "답하기 전에 단계별로 생각",
  "chat.noteQuick": "짧은 답변에 가장 빠름",
  "chat.noteEveryday": "일상적인 질문에 적당함",
...
const pt = {
  ...
  "chat.onThisMachine": "Neste computador",
  "chat.cloudSection": "Nuvem",
  "chat.noteLlama": "Confiável para tudo",
  "chat.noteQwen": "Melhor raciocínio para o tamanho",
  "chat.notePhi": "Segue melhor instruções detalhadas",
  "chat.noteGranite": "Fica mais próximo dos seus documentos",
  "chat.noteGemma": "Lida bem com documentos longos",
  "chat.noteMistral": "Respostas rápidas e diretas",
  "chat.noteCode": "Feito para código, não para prosa",
  "chat.noteThinks": "Pensa passo a passo antes de responder",
  "chat.noteQuick": "Mais rápido para respostas curtas",
  "chat.noteEveryday": "Equilibrado para perguntas do dia a dia",
...
const es419 = {
  ...
  "chat.onThisMachine": "En esta computadora",
  "chat.cloudSection": "Nube",
  "chat.noteLlama": "Confiable para todo",
  "chat.noteQwen": "Mejor razonamiento para su tamaño",
  "chat.notePhi": "El que mejor sigue instrucciones detalladas",
  "chat.noteGranite": "Se apega más a tus documentos",
  "chat.noteGemma": "Maneja bien los documentos largos",
  "chat.noteMistral": "Respuestas rápidas y directas",
  "chat.noteCode": "Hecho para código, no para prosa",
  "chat.noteThinks": "Piensa paso a paso antes de responder",
  "chat.noteQuick": "El más rápido para respuestas cortas",
  "chat.noteEveryday": "Equilibrado para preguntas cotidianas",
...
const esES = {
  ...es419,
  "chat.onThisMachine": "En este ordenador",
  "chat.add": "Añadir",
  "chat.uploadDoc": "Subir un documento",
