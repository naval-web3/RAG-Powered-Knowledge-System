...
const en = {
  ...
  "docs.sortAdded": "Date added",
  "docs.searchDocs": "Search documents…",
...
const fr = {
  ...
  "docs.sortAdded": "Date d’ajout",
  "docs.searchDocs": "Rechercher des documents…",
...
const de = {
  ...
  "docs.sortAdded": "Hinzugefügt am",
  "docs.searchDocs": "Dokumente durchsuchen…",
...
const hi = {
  ...
  "docs.sortAdded": "जोड़ने की तिथि",
  "docs.searchDocs": "दस्तावेज़ खोजें…",
...
const id = {
  ...
  "docs.sortAdded": "Tanggal ditambahkan",
  "docs.searchDocs": "Cari dokumen…",
...
const it = {
  ...
  "docs.sortAdded": "Data di aggiunta",
  "docs.searchDocs": "Cerca documenti…",
...
const ko = {
  ...
  "docs.sortAdded": "추가한 날짜",
  "docs.searchDocs": "문서 검색…",
...
const pt = {
  ...
  "docs.sortAdded": "Data de adição",
  "docs.searchDocs": "Pesquisar documentos…",
...
const es419 = {
  ...
  "docs.sortAdded": "Fecha de incorporación",
